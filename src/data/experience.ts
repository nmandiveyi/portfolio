export const experiences = [
  ...
  },
  {
    ...
    description:
      'Built and scaled a full-stack real estate platform managing 10,000+ property listings. Owned application architecture, APIs, data models, and cloud-hosted backend services on AWS end to end.',
    highlight: '↑ 53% faster page loads',
  },
] as const
